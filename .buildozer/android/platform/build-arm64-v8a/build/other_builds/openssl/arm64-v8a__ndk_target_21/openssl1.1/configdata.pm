...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/usr/bin/ccache /home/cat/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a",
  CFLAGS => [ "-target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a" ],
  CPPDEFINES => [ "__ANDROID_API__=21" ],
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/cat/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/aarch64-linux-android -I/home/cat/Desktop/kivy_glucose/.buildozer/android/platform/build-arm64-v8a/build/python-installs/kivyglucose/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/cat/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a",
  CXXFLAGS => [ "-target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/cat/Desktop/kivy_glucose/.buildozer/android/platform/build-arm64-v8a/build/libs_collections/kivyglucose/arm64-v8a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/usr/bin/ccache /home/cat/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target aarch64-linux-android21 -fomit-frame-pointer -march=armv8-a",
  minor => "1.1",
